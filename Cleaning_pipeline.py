...
#    X_train, X_test = sales_customer_store_day(X_train, X_test)
    ...
    # calculate sunday mean sales

    # sunday_mean = X_train[X_train.DayOfWeek == 7].sales_customer_store_day.mean()
    # # replace missing values with mean
    # select = X_test.loc[:, 'sales_customer_store_day'].isnull()
    # X_test.loc[select, 'sales_customer_store_day'] = mean
